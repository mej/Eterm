...
begin menu
  title Tiled
  TILE_IMAGE_ITEM(`70s Marble', `70s_marble.jpg')
  TILE_IMAGE_ITEM(`Atoms', `atoms.jpg')
  TILE_IMAGE_ITEM(`Black Stone', `blackstone.jpg')
  TILE_IMAGE_ITEM(`Blue Ether', `ether_blue.jpg')
  TILE_IMAGE_ITEM(`Blue Marble', `blue_marble.jpg')
  TILE_IMAGE_ITEM(`Bubbly 1', `bubbly1.jpg')
  TILE_IMAGE_ITEM(`Bubbly 2', `bubbly2.jpg')
  TILE_IMAGE_ITEM(`Bubbly 3', `bubbly3.jpg')
  TILE_IMAGE_ITEM(`Bubbly 4', `bubbly4.jpg')
  TILE_IMAGE_ITEM(`Circuit', `circuit.jpg')
  TILE_IMAGE_ITEM(`Confusion', `confusion.jpg')
  TILE_IMAGE_ITEM(`Cyber Playground', `cyber_bg.jpg')
  TILE_IMAGE_ITEM(`Dimples', `014.jpg')
  TILE_IMAGE_ITEM(`Dirt', `dirt.jpg')
  TILE_IMAGE_ITEM(`Egg', `egg.jpg')
  TILE_IMAGE_ITEM(`Ether', `ether.jpg')
  TILE_IMAGE_ITEM(`Giger 1', `giger1.jpg')
  TILE_IMAGE_ITEM(`Giger 2', `giger2.jpg')
  TILE_IMAGE_ITEM(`Gray Matter', `22.jpg')
  TILE_IMAGE_ITEM(`Gray Waves', `59.jpg')
  TILE_IMAGE_ITEM(`Green Ether', `ether_green.jpg')
  TILE_IMAGE_ITEM(`Lava', `004.jpg')
  TILE_IMAGE_ITEM(`Nebula', `nebula.jpg')
  TILE_IMAGE_ITEM(`On Stage', `lightb1.jpg')
  TILE_IMAGE_ITEM(`Purple Stuff', `purple_stuff.jpg')
  TILE_IMAGE_ITEM(`Red Whisper', `40.jpg')
  TILE_IMAGE_ITEM(`Shale', `shale.jpg')
  TILE_IMAGE_ITEM(`Soft Marble', `soft.jpg')
  TILE_IMAGE_ITEM(`Space', `space.png')
  TILE_IMAGE_ITEM(`Starry Night', `starry.jpg')
  TILE_IMAGE_ITEM(`Steel', `steel1.jpg')
  TILE_IMAGE_ITEM(`Twisted', `twisted.jpg')
  TILE_IMAGE_ITEM(`Whirlpool', `015.jpg')
end
begin menu
  title Scaled
  SCALE_IMAGE_ITEM(`Day/Night', `day-night.jpg')
  SCALE_IMAGE_ITEM(`Good Morning', `good-morning.jpg')
  SCALE_IMAGE_ITEM(`Neopolis', `Neopolis-horizon.jpg')
  SCALE_IMAGE_ITEM(`Pond', `pond.jpg')
  SCALE_IMAGE_ITEM(`Ripple', `ripple.jpg')
  SCALE_IMAGE_ITEM(`Sunset', `sunset.jpg')
  SCALE_IMAGE_ITEM(`Wasteland', `wasteland.jpg')
  SCALE_IMAGE_ITEM(`Winter Tree', `wintertree.jpg')
end
begin menu
  title Attrib
